...
```bash
python3 week-02-post-original-holbein/sharp-studio/server.py --port 8765
```
...
ml-sharp/.venv/bin/python week-02-post-original-holbein/sharp-studio/server.py --port 8765
```
...
```bash
cd week-02-post-original-holbein/anamorph
